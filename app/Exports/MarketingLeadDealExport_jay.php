...
class MarketingLeadDealExport_jay implements FromCollection, WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new AllLeadsSheet();
        $sheets[] = new WeeklyLeadsSheet();

        return $sheets;
    }
}

class AllLeadsSheet implements FromCollection, WithTitle
{
    public function title(): string
    {
        return 'AllOwer'; // Sheet name
    }
...
class WeeklyLeadsSheet implements FromCollection, WithTitle
{
    public function title(): string
    {
        return 'Week'; // Sheet name
    }
    ...
    public function collection()
    {
        ...
        $Query->selectRaw('CONCAT(electrician.first_name," ",electrician.last_name) AS electrician_name');
        $Query->selectRaw('DATE(leads.created_at) AS created_date');
        $Query->whereRaw('YEAR(leads.created_at) = YEAR(CURRENT_DATE)')
            ->whereRaw('WEEK(leads.created_at) = WEEK(CURRENT_DATE)');

...
class WonDealExport implements FromCollection
{
    protected $startDate;
    protected $endDate;
    ...
    public function collection()
    {
        ...
        $objNewItemHeader['material_sent_throught'] = 'Material sent through Channel partner';
        $objNewItemHeader['won_status_date'] = 'Won Status Date & Time';
        $objNewItemHeader['won_by'] = 'Won Status by';
        ...
        foreach ($leaddata as $lead_key => $lead_value) {
            ...
            $objNewItem['material_sent_throught'] = $MaterialSentBy;
            $objNewItem['won_status_date'] = '';
            $objNewItem['won_by'] = '';
            if($LeadStatusUpdate){
                $objNewItem['won_status_date'] = $LeadStatusUpdate['won_status_date'];
                $objNewItem['won_by'] = $LeadStatusUpdate['won_by_name'];
            }

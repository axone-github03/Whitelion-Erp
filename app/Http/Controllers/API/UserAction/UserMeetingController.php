...
class UserMeetingController extends Controller
{
    ...
    function detail(Request $request)
    {
        ...
        if ($UserMeeting) {
            ...
            $UserMeeting['meeting_time_data']['id'] = date('h:i A', strtotime($UserMeeting['meeting_date_time']));
            $UserMeeting['meeting_time_data']['text'] = date('h:i A', strtotime($UserMeeting['meeting_date_time']));

            $UserMeeting['reminder_data']['id'] = getReminderTimeSlot()[$UserMeeting['reminder_id']]['name'];
            $UserMeeting['reminder_data']['text'] = getReminderTimeSlot()[$UserMeeting['reminder_id']]['name'];
            ...
            $UserMeetingParticipant = UserMeetingParticipant::query()->where('meeting_id', $UserMeeting['id'])->orderby('id', 'asc')->get();
            ...
            $CRMSettingCallOutcomeType = CRMSettingMeetingOutcomeType::select('id', 'name as text')->find($UserMeeting['outcome_type']);
            if ($CRMSettingCallOutcomeType) {
                ...
                $UserMeeting['outcome_type'] = $CRMSettingCallOutcomeType;
            }

...
class UserTaskController extends Controller
{
    ...
    function detail(Request $request)
    {
        ...
        if ($UserTask) {
            ...
            $UserTask['due_time_data']['id'] = date('h:i A', strtotime($UserTask['due_date_time']));
            $UserTask['due_time_data']['text'] = date('h:i A', strtotime($UserTask['due_date_time']));

            $UserTask['reminder_data']['id'] = getReminderTimeSlot()[$UserTask['reminder_id']]['name'];
            $UserTask['reminder_data']['text'] = getReminderTimeSlot()[$UserTask['reminder_id']]['name'];
            ...
            $CRMSettingCallOutcomeType = CRMSettingTaskOutcomeType::select('id', 'name as text')->find($UserTask['outcome_type']);
            if ($CRMSettingCallOutcomeType) {
                ...
                $UserTask['outcome_type'] = $CRMSettingCallOutcomeType;
            }

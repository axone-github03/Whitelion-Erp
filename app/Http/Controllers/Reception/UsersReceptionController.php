...
class UsersReceptionController extends Controller {
	...
	public function index() {
		$data = array();
		$data['title'] = "Reception - Users";
		$data['country_list'] = CountryList::get();
		$data['type'] = 12;
		return view('users/reception', compact('data'));
	}
	...
	public function ajax(Request $request) {
		...
		$recordsTotal = DB::table('users')->where('type', 12)->count();

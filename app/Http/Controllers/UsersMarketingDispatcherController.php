...
class UsersMarketingDispatcherController extends Controller {
	...
	public function index() {
		$data = array();
		$data['title'] = "Marketing - Dispatcher - Users";
		$data['country_list'] = CountryList::get();
		$data['type'] = 7;
		return view('users/marketing_dispatcher', compact('data'));
	}
	...
	function export() {
		...
		header('Content-Disposition: attachment; filename="users-marketing.csv"');

...
class UsersProductionController extends Controller {
	...
	public function index() {
		$data = array();
		$data['title'] = "Production -  Users";
		$data['country_list'] = CountryList::get();
		$data['type'] = 5;
		return view('users/production', compact('data'));
	}
	...
	public function ajax(Request $request) {
		...
		$recordsTotal = DB::table('users')->where('type', 5)->count();
	...
	function export() {
		...
		header('Content-Disposition: attachment; filename="users-production.csv"');

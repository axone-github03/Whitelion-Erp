...
class CreateWlmstItemSubgroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wlmst_item_subgroups', function (Blueprint $table) {
            $table->id();
            $table->string('itemsubgroupname')->default('');
    ...
    {
        Schema::dropIfExists('wlmst_item_subgroups');
    }
}

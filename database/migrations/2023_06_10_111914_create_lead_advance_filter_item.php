...
class CreateLeadAdvanceFilterItem extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lead_advance_filter_item', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('lead_advance_filter_item');
    }
}

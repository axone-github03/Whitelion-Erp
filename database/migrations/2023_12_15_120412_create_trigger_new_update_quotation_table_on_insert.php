...
class CreateTriggerNewUpdateQuotationTableOnInsert extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
        DROP TRIGGER IF EXISTS `update_quotation_table_on_insert`;CREATE DEFINER=`root`@`localhost` TRIGGER `update_quotation_table_on_insert` AFTER INSERT ON `wltrn_quot_itemdetails` FOR EACH ROW BEGIN
...
END
    ...
    {
        DB::unprepared('DROP TRIGGER `update_quotation_table_on_insert`');
    }
}

        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Bills
                    ...
                    <div class="page-title-right">
                        ...
                        @if(isCreUser() == 1)
                            <a href="{{ route('bill.add') }}" class="btn btn-primary"><i class="bx bx-plus"></i>Bill</a>
                        @endif
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasExportOrder" aria-labelledby="canvasExportOrderLabel">
                            ...
                            <div class="offcanvas-body">
                                <form id="formExportReport" class="custom-validation" action="{{route('bill.export')}}" method="POST">
                                    @csrf
                        ...
                        @if(isCreUser() == 0 && isAccountUser() == 0)
                            <a class="btn btn-primary waves-effect waves-light" href="{{route('bill.add')}}" role="button"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Bill</a>
                        @endif
                    </div>
                </div>
...
<div class="modal fade" id="modalOrderDate" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" role="dialog" aria-labelledby="modalOrderDateLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="formOrderDate" action="{{route('bill.created.save')}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
...
<script type="text/javascript">
    ...
    var ajaxURL = "{{route('bill.ajax')}}";
    var ajaxOrderDetail = "{{route('bill.detail')}}";
    var ajaxOrderCancel = "{{route('bill.cancel')}}";

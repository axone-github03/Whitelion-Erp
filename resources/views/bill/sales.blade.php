...
<div class="modal fade" id="modalOrder" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" role="dialog" aria-labelledby="modalOrderLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <form id="formInvoice" action="{{route('bill.sales.invoice.save')}}" method="POST" class="needs-validation" novalidate>
                @csrf
...
<script type="text/javascript">
    ...
    var ajaxURL = "{{route('bill.sales.ajax')}}";
    var ajaxOrderDetail = "{{route('bill.sales.detail')}}";
    var ajaxOrderCancelDetail = "{{route('bill.sales.cancel.detail')}}";
    var ajaxInvoiceCalculation = "{{route('bill.sales.invoice.calculation')}}";
    var ajaxSearchChannelPartner = "{{route('bill.search.channel.partner')}}";
    var ajaxSearchProduct = "{{route('bill.search.product')}}";
    var ajaxOrderCancel = "{{route('bill.partial.cancel')}}";

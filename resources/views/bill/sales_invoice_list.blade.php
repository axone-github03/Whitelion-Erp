  ...
  <div class="table-responsive">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasEditInvoice" aria-labelledby="canvasEditInvoiceLable">
                                            ...
                                            <div class="offcanvas-body">
                                                 <form enctype="multipart/form-data" id="formInvoice" class="custom-validation" action="{{route('bill.sales.invoice.file.update')}}" method="POST"  >
...
<script type="text/javascript">
    ...
    var ajaxURL='{{route('bill.sales.invoice.list.ajax')}}';
    var ajaxInvoiceDetail='{{route('bill.sales.invoice.detail')}}';

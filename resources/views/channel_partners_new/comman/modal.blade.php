...
<div class="modal fade" id="modalUser" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <form id="formUser" action="{{ route('new.channel.partners.save') }}" method="POST"
...
<script type="text/javascript">
    var ajaxURLChannelPartnerDiscount = '{{ route('new.channel.partners.discount.ajax') }}';
    var ajaxURLChannelPartnerTypeDiscount = '{{ route('new.channel.partners.type.discount.ajax') }}';
    ...
    var ajaxSearchSalePerson = '{{ route('new.channel.partners.search.sale.person') }}';
    ...
    var ajaxURLChannelPartnerDiscountSearchProductGroup ='{{ route('new.channel.partners.discount.search.product.group') }}';
    var ajaxURLChannelPartnerDiscountCptSaveAll = '{{ route('new.channel.partners.discount.cpt.save.all') }}';

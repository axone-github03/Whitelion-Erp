...
<div class="d-flex flex-wrap p-2">
    <button type="button" class="btn btn-sm waves-effect waves-light bg-white"
        onclick="smoothScroll(document.getElementById('tab_detail_channel'))">
...
<div class="tab-content p-2 text-muted" style="overflow: hidden scroll;">
    <div class="tab-pane active" id="home" role="tabpanel">
        <div class="card lead-detail" style="border-radius: 10px;" id="tab_detail_channel">
            @include('user_action.detail_tab.detail_tab_channel')
        </div>
        ...
        <div class="card lead-detail" style="border-radius: 10px;" id="tab_deal">
            @include('user_action.detail_tab.detail_channel_partner_deal_tab')
        </div>
...
<script>
    ...
    var ajaxURLSearchSalePerson = "{{ route('new.channel.partners.search.sale.person') }}";

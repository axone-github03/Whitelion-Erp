                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Inquiry -  Move Assignee
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                                      ...
                                                      <form  id="formMoveAssignee" action="{{route('inquiry.move.assignee.save')}}" method="POST"  class="needs-validation" novalidate>
...
var ajaxSearchAssigneee='{{route('inquiry.move.assignee.search.assigned.user')}}';

        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Site Type</h4>
                    @include('../crm/setting/comman')

                    <div class="page-title-right">


                        <button id="addBtnData" class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#canvasMainMaster" aria-controls="canvasMainMaster"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Site Type </button>


                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasMainMaster" aria-labelledby="canvasDataLable">
                            <div class="offcanvas-header">
                                <h5 id="canvasDataLable">Site Type</h5>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formData" class="custom-validation" action="{{route('crm.setting.site.type.save')}}" method="POST">
...
<script type="text/javascript">
    var ajaxDataURL = "{{route('crm.setting.site.type')}}";
    var ajaxDataDetailURL = "{{route('crm.setting.site.type.detail')}}";
    ...
    $("#addBtnData").click(function() {
        ...
        $("#canvasDataLable").html("Add Site Type");
        $("#formData").show();
        $(".loadingcls").hide();
        resetInputForm();
        ...
        $.ajax({
            ...
            success: function(resultData) {
                if (resultData['status'] == 1) {
                    ...
                    if (resultData['data']['is_bhk'] == 1) {
                        $("#is_bhk").prop('checked', true);
                    } else {
                        $("#is_bhk").prop('checked', false);
                    }

                    ...
                    <div class="card shadow-sm mini-stats-wid count_card" id="ARCHITECT">
                        ...
                        <div class="card-body rounded-3 p-2">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <a href="javascript:void(0)" onclick="ViewbarChart('ARCHITECT');"><p class="hightlight_text text-dark fw-medium mb-0 font-size-12" id="ARCHITECT">New Architect </br><span class="text-dark mb-0 fw-bold" id="architects_count">0</span></p></a>
                                    <a href="javascript:void(0)" onclick="ViewbarChart('REWARD_ARCHITECT');"><p class="hightlight_text text-dark fw-medium mb-0 font-size-12 d-none" id="REWARD_ARCHITECT">Reward Order : <span class="text-dark mb-0 fw-bold" id="architects_reward_count">0</span></p></a>
                                </div>
                    ...
                    <div class="card shadow-sm mini-stats-wid count_card" id="ELECTRICIAN">
                        ...
                        <div class="card-body rounded-3 p-2">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <a href="javascript:void(0)" onclick="ViewbarChart('ELECTRICIAN');"><p class="hightlight_text text-dark fw-medium mb-0 font-size-12" id="ELECTRICIAN">New Elecrician </br><span class="text-dark mb-0 fw-bold" id="electricians_count">0</span></p></a>
                                    <a href="javascript:void(0)" onclick="ViewbarChart('REWARD_ELECTRICIAN');"><p class="hightlight_text text-dark fw-medium mb-0 font-size-12 d-none" id="REWARD_ELECTRICIAN">Reward Order : <span class="text-dark mb-0 fw-bold" id="electricians_reward_count">0</span></p></a>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="float-end ms-2" id="report_amount">
                                    <button type="button" class=" ms-2 btn-sm btn btn-outline-dark waves-effect waves-light float-end" aria-haspopup="true" aria-expanded="false">Quotation Amount: <span id="report_qutation_amount">0.00</span></button>
                                    <button type="button" class="btn-sm btn btn-outline-dark waves-effect waves-light float-end" aria-haspopup="true" aria-expanded="false">Billing Amount: <span id="report_billing_amount">0.00</span></button>
                                </div>
                                ...
                                <table id="datatable" class="table align-middle table-nowrap mb-0 dt-responsive">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th id="col_3" class="text-center">Channel Partner</th>
...
@section('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        //     selectedSalePersons.push('' + "{{Auth::user()->id}}" + '');
        //     var newOption = new Option("{{Auth::user()->first_name.' '.Auth::user()->last_name}}", "{{Auth::user()->id}}", false, false);
        //     $('#sales_user_id').append(newOption).trigger('change');
        //     $("#sales_user_id").val(selectedSalePersons).change();
        // @endif
    ...
    <script src="{{ asset('assets/js/c/dashboard-count-old.js') }}?v={{date("YmdHis")}}"></script>
    <script type="text/javascript">

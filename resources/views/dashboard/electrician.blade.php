                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <a href="{{ route('crm.lead') }}" target="_blank" class="text-decoration-none">
                                            ...
                                            <h4 class="text-white mb-0">{{ $data['electrician']->total_lead_deal }}</h4>
                                        </a>
                                    </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <a href="{{ route('architect.log') }}" target="_blank" class="text-decoration-none">
                                        ...
                                        <h4 class="text-dark mb-0">{{ $data['electrician']->lifetime_point }}</h4>
                                    </a>
                                </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <a href="{{ route('architect.orders') }}" target="_blank" class="text-decoration-none">
                                        ...
                                        <h4 class="text-dark mb-0">{{ $data['electrician']->redeemed_point }}</h4>
                                    </a>
                                </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <a href="{{ route('architect.gift.products') }}" target="_blank" class="text-decoration-none">
                                        ...
                                        <h4 class="text-dark mb-0">{{ $data['electrician']->available_point }}</h4>
                                    </a>
                                </div>

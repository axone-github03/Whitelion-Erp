...
<div class="row ps-3 flex-nowrap align-items-center">
    <div class="col-3 col-lg-6 col-xl-3">
        <input type="hidden" name="user_main_detail_id" id="user_main_detail_id" value="{{ $data['user']['id'] }}">
        <input type="hidden" name="hidden_is_arc" id="hidden_is_arc" value="0">
    ...
    <div class="row ms-1">
        <div class="bg-light p-2 border-info" style="width: fit-content;">
            <div class="d-flex flex-column ms-3 pe-3 text-primary"
                ...
                <b>Lifetime Pt.</b>
                <span class="" style="font-weight: bold;" id="ele_lifetime_point">0</span>
            </div>
        </div>
        <div class="bg-light p-2 border-info" style="width: fit-content;">
            <div class="d-flex flex-column pe-3 text-danger"
                style="border-right: 1px solid #c2ccff;height: auto; margin-top: 10px; margin-bottom: 10px;">
                <b>Redeemed Pt.</b>
                <span class="" style="font-weight: bold;" id="ele_redeemed_point">0</span>
            </div>
        </div>
        <div class="bg-light p-2 border-info" style="width: fit-content;">
            <div class="d-flex flex-column pe-3 text-success"
                style="border-right: 1px solid #c2ccff;height: auto; margin-top: 10px; margin-bottom: 10px;">
                <b>Available Pt.</b>
                <span class="" style="font-weight: bold;" id="ele_available_point">0</span>
            </div>
        </div>
        <div class="bg-light p-2" style="width: fit-content;">
            <div class="d-flex flex-column pe-3 text-primary"
                ...
                <b>Lead & Deal</b>
                <span class="" style="font-weight: bold;" id="ele_lead_and_deal_total_count">0</span>
            </div>
        </div>
    </div>
</div>
...
<div class="tab-content p-3 text-muted" style="max-height: 600px; overflow: scroll;">

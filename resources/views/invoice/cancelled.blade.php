        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Invoice Cancelled
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="invoice_track_id" name="invoice_track_id" placeholder="Track Id" value="" required>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" accept="@php
                                                    ...
                                                    echo implode(',',$fileTypes); @endphp" class="form-control" id="invoice_dispatch_detail" name="invoice_dispatch_detail[]" placeholder="Dispatch Detail" value="" multiple>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" accept="@php
                                                    ...
                                                    echo implode(',',$fileTypes); @endphp" class="form-control" class="form-control" id="invoice_eway_bill" name="invoice_eway_bill" placeholder="Eway Bills" value="">
...
<script type="text/javascript">
    var ajaxURL = "{{route('invoice.cancelled.ajax')}}";

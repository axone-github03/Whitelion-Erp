                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Invoice Dispatched
...
<script type="text/javascript">
    ...
    var ajaxURL='{{route('invoice.dispatched.ajax')}}';
    var ajaxInvoiceDetail='{{route('invoice.detail.dispatcher')}}';
    var ajaxInvoiceMarkAsRecieved='{{route('invoice.markasrecieved')}}';

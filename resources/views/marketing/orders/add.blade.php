                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formOrder" method="POST" action="{{ route('marketing.order.save') }}">
                                                    ...
                                                    <table class="table mb-0">
                                                        <tbody>
                                                            ...
                                                            <!--  <tr>
                                                                                                                    ...
                                                                                                                    <td class="text-danger"><i class="fas fa-rupee-sign"></i> <span id="order_summary_order_total_discount" ></td>
                                                                                                                </tr> -->
                                                            <tr>
                                                            ...
                                                            <!--  <tr>
                                                                                                                    ...
                                                                                                                    <td><i class="fas fa-rupee-sign"></i> <span id="order_summary_order_delivery_charge" ></span> </td>
                                                                                                                </tr> -->
                                                            <tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> Marketing Request </h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row d-none" id="custom_product">
                        <input type="hidden" name="" id="is_custom" name="is_custom">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="custom_width" class="form-label">Width (inch)</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="custom_height" class="form-label">Height (inch)</label>
                                <input type="number" class="form-control" id="custom_height" name="custom_height"
                                    placeholder="Height" value="0">
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-center">
                            <input type="hidden" id="custom_base_url" name="custom_base_url">
                            <div class="col-9 align-items-center">
                                <label for="custom_height" class="form-label">Box Preview</label>

                                <div class="col-12 row" id="custom_image">
                                    <span class="text-center" id="width_inch" style="margin-bottom: -8px;"></span>
                                    <div class="col-12 d-flex align-items-center justify-content-center p-2 px-4"
                                        style="position: relative;z-index: 1;text-align: -webkit-center;padding-top: 12px;">
                                        <span class="text-center span1" id="height_inch"
                                            style="margin-right: -12px;"></span>
                                        <div id="custom_box"
                                            style="border: 1px solid #000;max-width: 100%;height: 150px;width: 100%;"
                                            class="d-flex align-items-center justify-content-center"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 align-items-center">
                                <label for="custom_height" class="form-label">Wall Image</label>
                                <div class="product_image" style="position: absolute;">
                                    <img id="imgPreview" src="{{ asset('assets/images/item_image/placeholder.png') }}"
                                        alt="" class="img-thumbnail">
                                </div>
                                <label for="custom_height" id="product_image" class="form-label"
                                    style="position: relative;z-index: 1;padding: 14px;padding-top: 30px;">Click Here And
                                    Upload Wall Inage</label>
                                <input type="file" name="q_item_image" id="q_item_image" accept="image/*"
                                    style="display: none" />
                            </div>
                        </div>
                        {{-- <div>
...
@section('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        var ajaxSearchChannelPartner = "{{ route('marketing.order.search.channel.partner') }}";
        var ajaxChannelPartnerDetail = "{{ route('marketing.order.channel.partner.detail') }}";
        var ajaxSearchProduct = "{{ route('marketing.order.search.product') }}";
        var ajaxProductDetail = "{{ route('marketing.order.product.detail') }}";
        var ajaxOrderCalculation = "{{ route('marketing.order.calculation') }}";
        var reditectURL = "{{ route('marketing.orders') }}";
        ...
        function custom_box_width() {
            ...
            if (width > 200) {
                $('#custom_width').val(200);
            }
            //  else if (width < 5) {
            //     $('#custom_width').val(5);
            // }
            if (width > 10) {
                $('#custom_box').css('width', width_px + "vh");
            } else {
                $('#custom_box').css('width', width_px + "rem");
            }

            height = $("#custom_height").val();
            $('#width_inch').text(width + " Inch");
        }

        function custom_box_height() {
            height = $("#custom_height").val();
            if (height >= 100) {
                height_px = height / 4;
            } else if (height >= 50) {
            ...
            if (height > 10) {
                $('#custom_box').css('height', height_px + "vh");
            } else {
                $('#custom_box').css('height', height_px + "rem");
            }

            if (height_px == 5) {
                $height_number = 75 / 3;
                $('#height_number').text(height + " in");
                $('#height_number').css('height', $height_number);
                $('#height_number').css('line-height', $height_number + "px");
                $('#width_number').css('height', $height_number + "px");
            } else if (height > 10) {
                width = $('#custom_width').val();
                $height_number = height_px / 3;
                $('#height_number').css('height', $height_number + "vh");
                $('#height_number').css('line-height', $height_number + "vh");
                $('#width_number').css('height', $height_number + "vh");
            } else {
                width = $('#custom_width').val();
                $height_number = height_px / 3;
            }
            $('#height_inch').text(height + " Inch");


        }

        $('#custom_width').on("keyup change", function() {
            custom_box_width();
        });

        $('#custom_height').on("keyup change", function() {
            custom_box_height();
        });
                ...
                $.ajax({
                    ...
                    success: function(resultData) {
                        if (resultData['status'] == 1) {
                            ...
                            $("#product_lable").val(resultData['data']['product_code']['name']);
                            ...
                            if (resultData['data']['is_custome'] == 1) {
                                ...
                                // $("#custom_width").val(5);
                                // $("#custom_height").val(5);
                                $('#custom_product').removeClass('d-none');
                                custom_box_height();
                                custom_box_width();
                            } else {
                                $('#is_custom').val(0);
                                ...
                                $("#custom_height").val(0);
                                $('#imgPreview').attr('src', ' ');
                                $('#custom_product').addClass('d-none');
                            }
        ...
        function processAddCart() {
            ...
            if ($('#is_custom').val() == 1) {
                currentProduct['width'] = $("#custom_width").val();
                currentProduct['height'] = $("#custom_height").val();
                currentProduct['sample_image'] = $('#imgPreview').attr('src');
                currentProduct['box_image'] = $('#custom_base_url').val();

            } else {
                currentProduct['width'] = 0;
                currentProduct['height'] = 0;
                currentProduct['sample_image'] = " ";
                currentProduct['box_image'] = " ";
            }
        ...
        $("#btnAddCart").click(function() {
            var container = document.getElementById("custom_image");
            html2canvas(container, {
                allowTaint: true
            }).then(function(canvas) {
                $('#custom_base_url').val(canvas.toDataURL());
            });
            ...
            if ($('#is_custom').val() == 1) {
                ...
                var is_height = 0;
                var is_image = 0;
                if ($("#custom_width").val() == 0 || $("#custom_width").val() == "") {
                    toastr["error"]("Please Enter Width");
                    is_width = 1;
                }

                if ($("#custom_height").val() == 0 || $("#custom_height").val() == "") {
                    toastr["error"]("Please Enter Height");
                    is_height = 1;
                }

                if ($('#q_item_image').val() == "" || $('#q_item_image').val() == null) {
                    toastr["error"]("Please Upload Wall Image");
                    is_image = 1;
                }

                if (is_width == 0 && is_height == 0 && is_image == 0) {
                    processAddCart();
                }
            } else {
                processAddCart();
                ...
                success: function(resultData) {
                    ...
                    if (resultData['status'] == 1) {
                        ...
                        for (var i = 0; i < resultData['order']['items'].length; i++) {
                            ...
                            htmlTR += '<input type="hidden" class="input_box_width"  value="' + resultData[
                                'order']['items'][i]['width'] + '" id="input_box_width_' + resultData[
                                'order']['items'][i]['id'] + '" name="input_width[]">';
                            htmlTR += '<input type="hidden" class="input_box_height"  value="' + resultData[
                                'order']['items'][i]['height'] + '" id="input_box_height_' + resultData[
                                'order']['items'][i]['id'] + '" name="input_height[]">';
                            htmlTR += '<input type="hidden" class="input_box_image"  value="' + resultData[
                                'order']['items'][i]['box_image'] + '" id="input_box_image_' + resultData[
                                'order']['items'][i]['id'] + '" name="input_box_image[]">';
                            htmlTR += '<input type="hidden" class="input_sample_image"  value="' + resultData[
                                    'order']['items'][i]['sample_image'] + '" id="input_sample_image_' +
                                resultData['order']['items'][i]['id'] + '" name="input_sample_image[]">';
                            htmlTR += '</div>';
                            htmlTR += '</td>';
        ...
        $("#product_qty_lable , #custom_width, #custom_height").keydown(function(event) {
            if (event.keyCode == 13) {
                // do something here
                if ($('#is_custom').val() == 1) {
                    var is_width = 0;
        ...
        function openbase64image(data) {
            var win = window.open();
            win.document.write('<iframe src="' + data +

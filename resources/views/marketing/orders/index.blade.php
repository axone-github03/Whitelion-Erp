        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Marketing Request
                    ...
                    <div class="page-title-right">
                        ...
                        @if(isMarketingUser() == 0 && isSalePerson() == 0)
                            <a class="btn btn-primary waves-effect waves-light" href="{{route('marketing.order.add')}}" role="button"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Marketing Request</a>
                        @endif
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    var ajaxURL = "{{route('marketing.orders.ajax')}}";
    var ajaxOrderDetail = "{{route('marketing.order.detail')}}";
            ...
            success: function(resultData) {
                if (resultData['status'] == 1) {
                    ...
                    for (var i = 0; i < resultData['data']['items'].length; i++) {
                        ...
                        {
                            // tBody += "<td>";
                            // tBody += "" + resultData['data']['items'][i]['width'] + "";
                            // tBody += "</td>";
                            // tBody += "<td>";
                            // tBody += "" + resultData['data']['items'][i]['height'] + "";
                            // tBody += "</td>";
                            tBody += "<td>";
                            tBody += "<a href="+getSpaceFilePath(resultData['data']['items'][i]['box_image'])+" target='_blank'><img src="+getSpaceFilePath(resultData['data']['items'][i]['box_image'])+" height="+25+"></a>";
                            tBody += "</br><span style='font-size: 10px;'>width : "+resultData['data']['items'][i]['width']+"</span>";
                            tBody += "</br><span style='font-size: 10px;'>height : "+resultData['data']['items'][i]['height']+"</span>";
                            tBody += "</td>";
                            tBody += "<td>";
                            tBody += "<a href="+getSpaceFilePath(resultData['data']['items'][i]['sample_image'])+" target='_blank'><img src="+getSpaceFilePath(resultData['data']['items'][i]['sample_image'])+" height="+25+"></a>";
                            tBody += "</td>";

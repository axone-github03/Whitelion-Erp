        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Purchase Hierarchy
                    ...
                    <div class="page-title-right">
                        ...
                        <button id="addBtnPurchaseHierarchy" class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#canvasPurchaseHierarchy" aria-controls="canvasPurchaseHierarchy"><i class="bx bx-plus font-size-16 align-middle me-2"></i>Purchase Hierarchy </button>


                        <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasPurchaseHierarchy" aria-labelledby="canvasPurchaseHierarchyLabel">
                            <div class="offcanvas-header">
                                <h5 id="canvasPurchaseHierarchyLabel">Purchase Hierarchy</h5>
                            ...
                            <div class="offcanvas-body">
                                ...
                                <form id="formSalesHierarch" class="custom-validation" action="{{route('purchase.hierarchy.save')}}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="sales_hierarchy_name" name="sales_hierarchy_name" placeholder="Name" value="" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="sales_hierarchy_code_d" name="sales_hierarchy_code_d" placeholder="" value="" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select id="purchase_hierarchy_status" name="purchase_hierarchy_status" class="form-control select2-apply">
...
<script type="text/javascript">
    var ajaxPurchaseHierarchyDataURL = "{{route('purchase.hierarchy.ajax')}}";
    var ajaxPurchaseHierarchyDetailURL = "{{route('purchase.hierarchy.detail')}}";
    var ajaxPurchaseHierarchySearchURL = "{{route('purchase.hierarchy.search')}}";
    var ajaxPurchaseHierarchyDeleteURL = "{{route('purchase.hierarchy.delete')}}";
    ...
    var table = $('#datatable').DataTable({
        ...
        "ajax": {
            "url": ajaxPurchaseHierarchyDataURL,
            "type": "POST",
            "data": {
                "_token": csrfToken,
            }
    ...
    $("#sales_hierarchy_parent_id").select2({
        ajax: {
            url: ajaxPurchaseHierarchySearchURL,
            dataType: 'json',
            delay: 0,
            data: function(params) {
                return {
                    id: function() {
                        return $("#sales_hierarchy_id").val()
                    },
        ...
        dropdownParent: $("#canvasPurchaseHierarchy")
    });
    ...
    function showResponse(responseText, statusText, xhr, $form) {
        ...
        if (responseText['status'] == 1) {
            ...
            reloadTable();
            resetInputForm();
            $("#canvasPurchaseHierarchy").offcanvas('hide');
    ...
    $("#addBtnPurchaseHierarchy").click(function() {

        $("#canvasPurchaseHierarchyLabel").html("Add Purchase Hierarchy");
    ...
    function editView(id) {
        ...
        $("#canvasPurchaseHierarchy").offcanvas('show');
        $("#canvasPurchaseHierarchyLabel").html("Edit Purchase Hierarchy #" + id);
        $("#formSalesHierarch").hide();
        $(".loadingcls").show();

        $.ajax({
            type: 'GET',
            url: ajaxPurchaseHierarchyDetailURL + "?id=" + id,
        ...
        Swal.fire({
            ...
            preConfirm: function(n) {
                return new Promise(function(t, e) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: ajaxPurchaseHierarchyDeleteURL + "?id=" + id,
                        success: function(resultData) {

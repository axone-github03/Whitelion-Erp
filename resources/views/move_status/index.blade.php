                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Move Status
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                                      ...
                                                      <form  id="formMoveAssignee" action="{{route('move.status.save')}}" method="POST"  class="needs-validation" novalidate>
                                  ...
                                  <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="from_assignee" class="form-label"> Assignee</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                          ...
                                                          <div class="form-check form-check-primary mb-3" id="allInquryRow" >
                                                            <input  class="form-check-input" type="checkbox" id="check_feature_all_inqury" name="check_feature_all_inqury"
                                                                checked >
                                                     ...
                                                     <div class="col-md-6" id="allInquryRow2">

                                                        <label for="inquiry_status" class="form-label">Move to Status</label>
                                                        <select class="select2-apply" id="inquiry_status_to" name="inquiry_status_to" >
...
var ajaxSearchAssigneee='{{route('move.status.search.assigned.user')}}';
var ajaxInquiry='{{route('move.status.inquiry.ajax')}}';
var csrfToken = $("[name=_token").val();

$("#from_assignee").change(function(){
displayInquiryTable();
});
    ...
    ajax: {
        ...
        data: function(params) {
            return {
                q: params.term, // search term
                page: params.page,
                user_id: function(){ return $("#from_assignee").val(); },
                is_channel_partner:function(){ return $("#check_feature_4").prop("checked"); }
            };
        },
        processResults: function(data, params) {
            // parse the results into the format expected by Select2
...
var table = $('#inquiryTable').DataTable({
    ...
    "ajax": {
        ...
        "data": {
            "_token": csrfToken,
            "assigned_to": function(){ return $("#from_assignee").val();},
            "inquiry_status":function(){return $("#inquiry_status").val();}
        }

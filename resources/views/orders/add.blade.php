                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formOrder" method="POST" action="{{ route('order.save') }}">
...
@section('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        var ajaxChannelPartnerDetail = '{{ route('order.channel.partner.detail') }}';
        var ajaxSearchProduct = '{{ route('order.search.product') }}';
        var ajaxProductDetail = '{{ route('order.product.detail') }}';
        var ajaxOrderCalculation = '{{ route('order.calculation') }}';
        var reditectURL = '{{ route('orders') }}';

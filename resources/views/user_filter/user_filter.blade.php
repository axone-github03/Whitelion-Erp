                    ...
                    <div class="row flex-nowrap align-items-center flex-fill">
                        ...
                        <div class="col-3 ps-0">
                            <div class="mb-1 mt-lg-0">
                                @if (isset($data['is_architect_module']))
                                    <input type="hidden" name="is_architect" id="is_architect" value="1">
                                ...
                                @elseif(isset($data['is_electrician_module']))
                                    <input type="hidden" name="is_architect" id="is_architect" value="0">
                                    <select class="form-control" id="selectAdvanceFilterColumn_0"
                                        name="selectAdvanceFilterColumn_0" required>
                                ...
                                <div class="col-md-12">
                                    <div class="ajax-select mt-lg-0">
                                        <select class="form-control select2-ajax" id="lead_filter_select_value_0"
                                            name="lead_filter_select_value_0"></select>
                                        <div class="invalid-feedback">
                                            Please select value.
                                        </div>
                                    </div>
